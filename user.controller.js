...
//       res.json({
//         status: true,
//         msg: "User fetch succesf111ully",
//         data:JSON.parse(query1),
//     })
//     const query = { $firstname: { $search: req.body.search } };
//     // User.find({$or:[{firstname: "/"+req.body.search+"/i"},{lastname:"/"+req.body.search+"/i"},{email:"/"+req.body.search+"/i"}]}).then((result)=>{
